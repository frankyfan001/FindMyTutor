...
var Spectra = _interopDefault(require('spectra'));
var reactSlotProps = require('react-slot-props');
  ...
  return function (Target) {
    return function (props) {
      return React__default.createElement(
        styled.ThemeConsumer,
        null,
        function (theme) {
          return React__default.createElement(Target, _extends$1({}, props, { theme: theme }));
        }
      );
    };
  };
...
var Text = themeable()(Rebass.Text);

var Heading = themeable()(Rebass.Heading);

var Flex = themeable()(Rebass.Flex);

var _Box = themeable()(Rebass.Box);

var Box = themeable()(styled__default(_Box)(minWidth, maxWidth));

var Button = themeable()(Rebass.Button);

var Link = themeable()(Rebass.Link);

var Image = themeable()(Rebass.Image);

var _Card = themeable()(Rebass.Card);

var Card = themeable()(styled__default(_Card)(minWidth, maxWidth));

var Block = themeable()(styled__default(Rebass.Box)(minWidth, maxWidth, themed('Block')));
      ...
      return React__default.createElement(
        ...
        layoutIs(imageAlign, ['top', 'left']) && slot.render(path + '.image', function (render, props) {
          return React__default.createElement(
            ...
            props.children ? renderChild(props.children) : React__default.createElement(Image, _extends$1({}, props, { width: '100%' }))
          );
        }),
                ...
                return React__default.createElement(
                  ...
                  slot.render(path + '.elements', function (render, props, type, key) {
                    return React__default.createElement(
                      ...
                      React__default.createElement(SmartContent, {
...
var exportComponents = reactSlotProps.createSlotComponents(ReactBanners, BannerRelations);
