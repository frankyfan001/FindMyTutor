  ...
  return (
    <div style={{margin: 50, zIndex: 0}}>
      <Accordion expanded={current === 0} onChange={changeState(0)}>
        ...
        <AccordionDetails>
          <Typography style={{wordWrap: "break-word"}} align="left">
            <b>For Callee:</b> copy your Online Tutoring ID and send it to your caller. <b>For Caller:</b> input your
            callee's Online Tutoring ID and call.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion expanded={current === 1} onChange={changeState(1)}>
        ...
        <AccordionDetails>
          <Typography style={{wordWrap: "break-word"}} align="left">
            Please make sure to check accessibility of your browser to allow FindMyTutor to access your camera and
            microphones.
          </Typography>
        </AccordionDetails>
      </Accordion>
